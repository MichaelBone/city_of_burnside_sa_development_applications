...
function requestPage(url, callback) {
    ...
    request.get({ uri: url, cert: fs.readFileSync("Test.crt"), agentOptions: { secureProtocol: "TLSv1_2_client_method", strictSSL: false, rejectUnauthorized: false, ca: fs.readFileSync("Test.crt") } }, (error, response, body) => {
        if (error)
